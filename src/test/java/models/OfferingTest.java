...
class OfferingTest {
    ...
    static void init() {
        ...
        assertEquals("00000", department.save());
        ...
        assertEquals("00000", instructor.save());
    ...
    @Test
    void save() {
        assertEquals("00000", offering.save());
    ...
    void retrieve() throws Exception {
        ...
        assertEquals("00000", retrievedoffering.save());
    }
    ...
    void delete() {
        ...
        assertEquals("00000", retrievedoffering.delete());
        assertEquals("00000", instructor.delete());
