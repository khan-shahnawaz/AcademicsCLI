...
class EnrollmentTest {
    ...
    @Order(16)
    void delete() {
        assertTrue(enrollment.delete());
        assertTrue(retrievedEnrollment.delete());
        assertTrue(offering.delete());
        assertTrue(offering2.delete());
        assertTrue(catalog.delete());
        assertTrue(catalog1.delete());
        assertTrue(academicCalender.delete());
        assertTrue(academicCalender2.delete());
        assertTrue(academicCalender3.delete());
        assertTrue(student.delete());
        assertTrue(instructor1.delete());
