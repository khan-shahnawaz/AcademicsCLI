...
class TeachingTeamTest {
    ...
    @Test
    void delete() {
        Assertions.assertTrue(teachingTeam.delete());
        Assertions.assertTrue(retrievedTeachingTeam.delete());
        Assertions.assertTrue(offering.delete());
        Assertions.assertTrue(catalog.delete());
        Assertions.assertTrue(instructor1.delete());
        Assertions.assertTrue(instructor2.delete());
        Assertions.assertTrue(department.delete());
        Assertions.assertTrue(academicCalender.delete());
        Assertions.assertTrue(academicCalender2.delete());
    }
}