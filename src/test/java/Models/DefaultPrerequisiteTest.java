...
class DefaultPrerequisiteTest {
    ...
    @Test
    void save() {
        Assertions.assertTrue(defaultPrerequisite.save());
    ...
    @Test
    void delete() {
        Assertions.assertTrue(defaultPrerequisite.delete());
        Assertions.assertTrue(retrievedDefaultPrerequisite.delete());
        Assertions.assertTrue(catalog1.delete());
        Assertions.assertTrue(catalog2.delete());
        Assertions.assertTrue(catalog3.delete());
    }
